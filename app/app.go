...
type App struct {
	*baseapp.BaseApp
	...
	LumenxKeeper lumenxmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		evidencetypes.StoreKey, ibctransfertypes.StoreKey, capabilitytypes.StoreKey, authzkeeper.StoreKey, monitoringptypes.StoreKey,
		lumenxmoduletypes.StoreKey,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		appCodec, keys[authtypes.StoreKey], app.GetSubspace(authtypes.ModuleName), authtypes.ProtoBaseAccount, maccPerms, sdk.Bech32PrefixAccAddr,
	)
	...
	app.AuthzKeeper = authzkeeper.NewKeeper(keys[authzkeeper.StoreKey], appCodec, bApp.MsgServiceRouter(), app.AccountKeeper)
	...
	app.GovKeeper = govkeeper.NewKeeper(
		...
		&stakingKeeper, govRouter, app.MsgServiceRouter(),
		govConfig,
	)
	...
	app.LumenxKeeper = *lumenxmodulekeeper.NewKeeper(
		appCodec,
		keys[lumenxmoduletypes.StoreKey],
		keys[lumenxmoduletypes.MemStoreKey],
		app.GetSubspace(lumenxmoduletypes.ModuleName),
	)
	lumenxModule := lumenxmodule.NewAppModule(appCodec, app.LumenxKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(lumenxmoduletypes.ModuleName)
